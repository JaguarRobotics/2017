...
/**
 * Turns robot a specified angle left or right. Positive angles turn
 * counter-clockwise.
 * 
 * @author Cody Moose
 * @version 2016
...
public class DriveTurn extends CommandBase {
	...
	protected boolean isFinished() {
		return (turnAmount >= 0 /* && driveSubsystem.getGyro() >= angle */)
				|| (turnAmount < 0 /* && driveSubsystem.getGyro() <= angle */);
	}
