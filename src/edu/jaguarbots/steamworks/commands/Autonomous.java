...
public class Autonomous extends CommandGroup
{
    ...
    public Autonomous(final Robot.Position position,
                    final Robot.MiddlePosition middlePosition,
                    final Robot.Doughnuts doughnuts)
    {
        ...
        switch (position)
        {
            case Left:
                /* Code goes here */
                /*
                 * addSequential(new EncoderTurn(-Math.PI / 3, turnSpeed)); addSequential(new EncoderDrive(20.35 *
                 * Math.pow(3, 1/2), straightSpeed));
                 */
                // addSequential(new GearShiftLow());
                addSequential(new EncoderDrive(92, straightSpeed));
                addSequential(new EncoderTurn(ds.getRadiansFromDegrees(-65),
                                turnSpeed));
                ...
                break;
            case Middle:
                boolean takeRightPath = middlePosition == Robot.MiddlePosition.Right
                                ? true : false;
                /* Code goes here */
                // addSequential(new GearShiftLow());
                addSequential(new EncoderDrive(
                                takeRightPath ? 93.3 - 31 + 15.25
                                                : 93.3 - 31 + 12,
                                straightSpeed));
                addSequential(new DrivePause(2000));
                addSequential(new EncoderDrive(-36, straightSpeed));
                addSequential(new EncoderTurn(
                                ds.getRadiansFromDegrees(
                                                takeRightPath ? -97 : 130),
                                turnSpeed));
                addSequential(new EncoderDrive(72, straightSpeed));
                addSequential(new EncoderArcTurn(
                                ds.getRadiansFromDegrees(
                                                takeRightPath ? 160 : -280),
                                turnSpeed));
                addSequential(new EncoderDrive(takeRightPath ? 36 : 12,
                                straightSpeed));
                addSequential(new EncoderArcTurn(
                                ds.getRadiansFromDegrees(
                                                takeRightPath ? 150 : -150),
                                turnSpeed));
                addSequential(new EncoderDrive(takeRightPath ? 60 : 120,
                                straightSpeed));
                /* Code goes here */
                break;
            case Right:
                ...
                addSequential(new EncoderTurn(ds.getRadiansFromDegrees(80),
                                turnSpeed));
        ...
        if(doughnuts == Robot.Doughnuts.Yes) addSequential(new EncoderTurn(ds.getRadiansFromDegrees(314159), 1)); // Delicousness
        addSequential(new GearShiftLow());
    }
}
